import{t as e}from"./index-BiV1rcgb.js";import{t}from"./lib-C2lagyiU.js";var n=e(),r={path:`/blog/how-to-create-live-updating-and-flexible-d3-line-charts-using-pseudo-data`,date:`1413270000000`,published:!0,tags:[`D3.js`,`JavaScript`],title:`How to create live updating and flexible D3.js line charts using D3.js v3 and pseudo-data (interactive tutorial and example)`,seoTitle:`Live-updating line charts in D3.js v3 (tutorial)`};function i(e){let r={a:`a`,code:`code`,h3:`h3`,p:`p`,pre:`pre`,span:`span`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(r.p,{children:[`NOTE: Looking for the newest version of this tutorial using the latest version of D3.js (v5)? See it `,(0,n.jsx)(r.a,{href:`/blog/how-to-create-live-updating-and-flexible-d3-line-charts-using-d3-js-v5-and-pseudo-data`,children:`here`})]}),`
`,(0,n.jsx)(r.p,{children:`One of the bigger challenges in visualizing data is making your charts responsive so that they can resize no matter what range of data is thrown at it. Things get even more complicated when the dataset is actually a collection of many individual sets of data. One obvious example of this is a dataset containing (x,y) coordinates for multiple lines. The goal is to create a chart similar to the one below, which adapts to any new data thrown at it.`}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:`language-javascript`,children:`var xScale = d3.scale.linear().range([0, width - margin.left - margin.right])
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsx)(r.code,{className:`language-javascript`,children:`// draw the lines
var lines = svg.selectAll('.line').data(data).attr('class', 'line')
...
`,(0,n.jsxs)(r.p,{children:[`That’s it! If you’re interested in seeing the complete code, go ahead and check out my bl.ocks: `,(0,n.jsx)(r.a,{href:`http://bl.ocks.org/jonsadka/482005612916b3f5e408`,children:`http://bl.ocks.org/jonsadka/482005612916b3f5e408`})]})]})}function a(e={}){let{wrapper:r}={...t(),...e.components};return r?(0,n.jsx)(r,{...e,children:(0,n.jsx)(i,{...e})}):i(e)}export{a as default,r as frontmatter};