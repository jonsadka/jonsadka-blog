import{t as e}from"./index-BiV1rcgb.js";import{t}from"./lib-C2lagyiU.js";var n=e(),r={path:`/blog/how-to-deploy-imgproxy-to-google-cloud-using-docker-and-cloud-run`,date:`1590562800000`,published:!0,tags:[`Infrastructure`],title:`How to deploy imgproxy to Google Cloud using Docker and Cloud Run`,seoTitle:`Deploy imgproxy to Google Cloud Run with Docker`};function i(e){let r={a:`a`,code:`code`,h3:`h3`,li:`li`,ol:`ol`,p:`p`,span:`span`,ul:`ul`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(r.h3,{id:`goal`,children:[(0,n.jsx)(r.a,{"aria-hidden":`true`,tabIndex:`-1`,href:`#goal`,children:(0,n.jsx)(r.span,{className:`icon icon-link`})}),`Goal`]}),`
