import{t as e}from"./index-BHGTRh0p.js";import{t}from"./lib-Ci7ycG-p.js";var n=e(),r={path:`/blog/how-to-export-photoshop-images-at-custom-resolutions-using-scripting`,date:`1576569600000`,published:!0,tags:[`JavaScript`,`Photoshop`,`Scripting`],title:`How to export Photoshop images at custom resolutions using Adobe Photoshop Scripting and JavaScript`};function i(e){let r={a:`a`,code:`code`,em:`em`,h3:`h3`,img:`img`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,...t(),...e.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsxs)(r.h3,{id:`goal`,children:[(0,n.jsx)(r.a,{"aria-hidden":`true`,tabIndex:`-1`,href:`#goal`,children:(0,n.jsx)(r.span,{className:`icon icon-link`})}),`Goal`]}),`
