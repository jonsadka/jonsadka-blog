 ...
 * Adapted for vanilla JS usage to replace canvas-sketch-util.
 */
class RandomGenerator {
    ...
    private hash(seed: string | number): number {
    ...
    noise2D(x: number, y: number): number {
        // Simple 2D noise implementation (Value Noise for simplicity, or Perlin)
        // For this specific topography effect, a smooth noise is needed.
        // Using a basic implementation of Perlin Noise.
